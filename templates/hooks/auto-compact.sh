...
# Auto-Compact Hook Script (Shell Version)
#
# Monitors context usage and warns when threshold is reached.
# This script is designed to be run as a Stop or PostToolUse hook.
#
# Configuration via environment:
# - COMPACT_THRESHOLD: Percentage (0-100) to trigger warning (default: 70)
# - CLAUDE_AUTO_COMPACT_DEBUG: Set to "1" to see debug output
#
# Usage in hooks.json:
# {
#   "hooks": {
